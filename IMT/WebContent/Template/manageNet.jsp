...
<body>
	 <div class="alert alert-info">当前位置<b class="tip"></b>管理员操作<b class="tip"></b>网站管理</div>
     <table class="tbform" >
            <tr>
    ...
    <table class="tb" id="list">
      ...
      <tr class="pager">
        <th colspan="100"><div>
		<a href='manageNet.do?pindex=1&&pcount=1' id="a1">首页</a>
		<a href='manageNet.do?pindex=${requestScope.page.pindex-1}&&pcount=1' id="a2">上一页</a>
		<a href='manageNet.do?pindex=${requestScope.page.pindex+1}&&pcount=1' id="a3">下一页</a> 
		<a href='manageNet.do?pindex=${requestScope.page.ptotalpages}&&pcount=1' id="a4">末页</a>
     ...
     <script language="JavaScript">
		...
		function edita(a){
	    	...
	    	$.dialog({
	    	title: 'test',
	    	content:'url:updateNet.do?id='+user,
	    	lock: true,
	    	okVal: '关了',
	    	ok: true,
	    	width: 800,
 	...
 	$(function(){
 		...
 		$('input[name="goPage"]').bind("click",function(){
 			...
 			if(reg.test(goPageNo)!=true){
 				...
 				window.location.href="manageNet.do?pindex="+goPageNo+"&&pcount=1";
 			}
 		});
