    ...
    <table class="tb" id="list">
      <tbody>
       <tr>
        ...
        <c:forEach var="item" items="${queryInvalidResource}"  varStatus="status">
        <tr>
      ...
      <tr class="pager">
        <th colspan="100">
        	 <div>
				<a href='queryInvalidResource.do?pindex=1&&pcount=1' id="a1">首页</a>
				<a href='queryInvalidResource.do?pindex=${requestScope.page.pindex-1}&&pcount=1' id="a2">上一页</a>
				<a href='queryInvalidResource.do?pindex=${requestScope.page.pindex+1}&&pcount=1' id="a3">下一页</a> 
				<a href='queryInvalidResource.do?pindex=${requestScope.page.ptotalpages}&&pcount=1' id="a4">末页</a>
 	...
 	$(function(){
 		...
 		$('input[name="goPage"]').bind("click",function(){
 			...
 			if(reg.test(goPageNo)!=true){
 				...
 				window.location.href="queryInvalidResource.do?pindex="+goPageNo+"&&pcount=1";
 			}
 		});
